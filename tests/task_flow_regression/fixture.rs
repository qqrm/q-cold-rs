...
"#,
    ...
    fn configure_taskflow_binary(
        ...
        cmd.current_dir(repo)
            ...
            .env_remove("QCOLD_AGENT_WORKTREE")
            .env_remove("QCOLD_OUTPUT_GUARD_ENABLED")
            .env_remove("QCOLD_OUTPUT_GUARD_BIN")
            .env_remove("QCOLD_OUTPUT_GUARD_COMMANDS")
            .env_remove("QCOLD_GUARD_QCOLD")
            .env_remove("QCOLD_GUARD_REAL_0_RG")
            .env_remove("QCOLD_GUARD_REAL_1_GIT")
